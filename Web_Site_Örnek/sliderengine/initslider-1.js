jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        descriptioncss:"display:block; position:relative; font:14px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,Arial; color:#000;  background-color:#fec146; margin-top:10px; padding:10px; ",
        ...
        showfacebook:true,
        titlecss:"display:table; position:relative; font:16px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,Arial; color:#000; white-space:nowrap; background-color:#e46822; padding:10px;",
        ribbonimagey:0,
        ribbonimagex:0,
